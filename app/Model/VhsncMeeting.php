 ...
 *
 */
class VhsncMeeting extends AppModel {
 ...
 * @var string
 */
	public $displayField = 'issue_details';
...
//		),
			...
			'foreignKey' => 'meeting_facilitated',
			'conditions' => '',
			'fields' => '',
			'order' => ''
		),
