...
<?php
echo $this->Form->input('name',array('class' => 'form-control','label'=>'Description'));
echo $this->Form->input('company_id',array('class' => 'form-control','options'=>array(''=>'--Select--',$company)));
