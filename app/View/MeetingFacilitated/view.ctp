...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Register Member'), array('action' => 'edit', $facilitated['MeetingFacilitated']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Register Member'), array('action' => 'delete', $facilitated['MeetingFacilitated']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $facilitated['MeetingFacilitated']['id'])); ?>
<?php echo $this->Html->link(__('List Register Member'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Html->link(__('New Register Member'), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
...
<h2><?php echo __('Register Member'); ?></h2>
<!--<dl>
<dt><?php echo __('Id'); ?></dt>
<dd>
<?php echo h($facilitated['MeetingFacilitated']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Name'); ?></dt>
<dd>
<?php echo h(ucfirst($facilitated['MeetingFacilitated']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($facilitated['MeetingFacilitated']['status'])); ?>
&nbsp;
</dd>
