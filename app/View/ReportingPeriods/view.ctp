...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Period'), array('action' => 'edit', $periods['ReportingPeriod']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Period'), array('action' => 'delete', $periods['ReportingPeriod']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $periods['ReportingPeriod']['id'])); ?>
...
<dd>
<?php echo h($periods['ReportingPeriod']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('From Date'); ?></dt>
<dd>
<?php echo h(date('d-m-Y',strtotime($periods['ReportingPeriod']['from_date']))); ?>
&nbsp;
</dd>
<dt><?php echo __('To Date'); ?></dt>
<dd>
<?php echo h(date('d-m-Y',strtotime($periods['ReportingPeriod']['to_date']))); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($periods['ReportingPeriod']['status'])); ?>
&nbsp;
</dd>
