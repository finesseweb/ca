...
<?php echo $this->Html->link(__('List Reporting Periods'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
echo "<div class=col-sm-3>".$this->Form->input('from_date',array('class' => 'form-control','type'=>'text','value'=>date('d-m-Y',strtotime($this->request->data['ReportingPeriod']['from_date']))))."</div>";
echo "<div class=col-sm-3>". $this->Form->input('to_date',array('class' => 'form-control','type'=>'text','value'=>date('d-m-Y',strtotime($this->request->data['ReportingPeriod']['to_date']))."</div>";
