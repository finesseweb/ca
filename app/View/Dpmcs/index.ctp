...
<th><?php echo $this->Paginator->sort('issue_shared_dpmc'); ?></th>
...
<td class="actions">
<a href="javascript:void(0)" class="more btn btn-success" data-toggle="modal" data-target="#myModal" data-id="<?=$anm['Dpmc']['district']?>,<?=$anm['Dpmc']['meeting_date']?>">More</a>
<?php /*?><?php 
...
$.ajax({url:"<?=SITE_PATH?>/dpmcs/viewissues/"+dataid,dataType:"html",success:function(result){
