...
<div class="btn-group">
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MoreCustomerFeed.id')),array('class' => 'btn btn-primary'), null, __('Are you sure you want to delete # %s?', $this->Form->value('MoreCustomerFeed.id'))); ?>
...
<fieldset>
<legend><?php echo __('Edit More Customer Feed'); ?></legend>
<div class="row">
<?php print_r($this->request->data['MoreCustomerFeed']['customer_feedback_id']);
...
<div class="col-sm-12"><input  onClick="addRow(this.form);" type="button" value="Add row">
<?php  echo $this->Form->input('id',array("name"=>"data[MoreCustomerFeed][id][]")); echo $this->Form->end(__('Submit')); ?>
</div>
</div>
</div>
