...
echo "<div class='col-sm-3'>".$this->Form->input('month',array('type'=>'text','class'=>'calbsp tform form-control','readonly'=>'readonly','value'=>date('M-Y',strtotime($this->request->data['Monthlyreport']['month']))))."</div>";
    ...
    if (c.length>12)
           {
                ...
                $( "#FacilityAssessmentMobileResponderOne" ).val('');
                return false;
           }
         else if(c.length<10){
