...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Cateory'), array('action' => 'edit', $reason['ReasonCategory']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Cateory'), array('action' => 'delete', $reason['ReasonCategory']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $reason['ReasonCategory']['id'])); ?>
...
<dd>
<?php echo h($reason['ReasonCategory']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Name'); ?></dt>
<dd>
<?php echo h(ucfirst($reason['ReasonCategory']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($reason['ReasonCategory']['status'])); ?>
&nbsp;
</dd>
