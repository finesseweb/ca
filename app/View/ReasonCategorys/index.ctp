...
<h2><?php echo __('Reason Category'); ?></h2>
...
<tr>
<td><?php echo h($reason['ReasonCategory']['id']); ?>&nbsp;</td>
<td><?php echo h(ucfirst($reason['ReasonCategory']['name'])); ?>&nbsp;</td>

<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $reason['ReasonCategory']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $reason['ReasonCategory']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $reason['ReasonCategory']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $reason['ReasonCategory']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
