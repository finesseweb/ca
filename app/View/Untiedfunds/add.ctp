...
<fieldset>
<legend><?php echo __('Add Untied Fund Detail'); ?></legend>
<div class="row">
<?php
...
echo "<div class='col-sm-3'>".$this->Form->input('constitution_date',array('class' => 'form-control','type'=>'text'))."</div>";
...
?>
 <div class="col-sm-3"><div class="input select"><label for="UntiedfundfinacialId">Financial Years</label>
