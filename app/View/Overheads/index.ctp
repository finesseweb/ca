...
<div class="btn-group">
<?php echo $this->Html->link(__('New Overhead'), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
<?php //echo $this->Html->link(__('Overhead Details'), array('controller' => 'overheads', 'action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<h2><?php echo __('Overhead Category'); ?></h2>
...
<tr>
<td><?php echo h($financial['Overhead']['id']); ?>&nbsp;</td>
...
<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $financial['Overhead']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financial['Overhead']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financial['Overhead']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $financial['Overhead']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
