...
<?php if(CakeSession::read('User.type')==='regular' and CakeSession::read('User.id')===$this->request->data['Resale']['user_id']) { ?>
<?php echo $this->Form->create('Resale'); ?>
	...
	echo "<tr><td width='30%'>".$this->Form->input('client_type',array('options'=>array(''=>'Select','buyer'=>'Buyer','seller'=>'Seller','dealer'=>'Dealer')))."</td><td width='30%'>".$this->Form->input('name')."</td><td width='30%'>".$this->Form->input('second_name')."</td></tr>";
