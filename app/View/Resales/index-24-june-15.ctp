...
<div class="horizon_menu"><ul><li><?php echo $this->Html->link(__('Add New'), array('action' => 'add')); ?></li></ul></div>
	...
	<tr>
		...
		<td><?php echo h($resale['Resale']['name']); ?>&nbsp;</td>
		<?php /*?><td><?php echo h($resale['Resale']['email']); ?>&nbsp;</td><?php */?>
		<td><?php echo h($resale['Resale']['contact']); ?>&nbsp;</td>
        ...
        <?php if(CakeSession::read('User.type')==='regular' and CakeSession::read('User.id')===$resale['Resale']['user_id']) {  echo $this->Html->link(__('Edit'), array('action' => 'edit', $resale['Resale']['id'])); } ?>
