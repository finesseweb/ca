...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Register Member'), array('action' => 'edit', $material['Discussion']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Register Member'), array('action' => 'delete', $material['Discussion']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $material['Discussion']['id'])); ?>
...
<dd>
<?php echo h($material['Discussion']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Name'); ?></dt>
<dd>
<?php echo h(ucfirst($material['Discussion']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($material['Discussion']['status'])); ?>
&nbsp;
</dd>
