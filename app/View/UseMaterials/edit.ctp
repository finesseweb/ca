...
<div class="btn-group">
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UseMaterial.id')),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $this->Form->value('UseMaterial.id'))); ?>
<?php echo $this->Html->link(__('List Materials'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<?php echo $this->Form->create('UseMaterial'); ?>
<fieldset>
<legend><?php echo __('Material'); ?></legend>
<?php
