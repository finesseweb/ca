...
<div class="btn-group">
<?php echo $this->Html->link(__('New Use Material '), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
...
<h2><?php echo __('Use Materials'); ?></h2>
...
<tr>
<td><?php echo h($material['UseMaterial']['id']); ?>&nbsp;</td>
<td><?php echo h(ucfirst($material['UseMaterial']['name'])); ?>&nbsp;</td>

<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $material['UseMaterial']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $material['UseMaterial']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $material['UseMaterial']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $material['UseMaterial']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
