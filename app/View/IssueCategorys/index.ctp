...
<tr>
<td><?php echo h($issuecategory['IssueCategory']['id']); ?>&nbsp;</td>
<td><?php echo h(ucfirst($issuecategory['IssueCategory']['name'])); ?>&nbsp;</td>

<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $issuecategory['IssueCategory']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $issuecategory['IssueCategory']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $issuecategory['IssueCategory']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $issuecategory['IssueCategory']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
