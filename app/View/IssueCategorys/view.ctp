...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Cateory'), array('action' => 'edit', $issueCategory['IssueCategory']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Cateory'), array('action' => 'delete', $issueCategory['IssueCategory']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $issueCategory['IssueCategory']['id'])); ?>
...
<dd>
<?php echo h($issueCategory['IssueCategory']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Name'); ?></dt>
<dd>
<?php echo h(ucfirst($issueCategory['IssueCategory']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($issueCategory['IssueCategory']['status'])); ?>
&nbsp;
</dd>
