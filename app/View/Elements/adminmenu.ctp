<header class="header">
<a href="<?=SITE_PATH?>users/welcome"><span class="logo"><img src="<?=SITE_PATH?>images/ca.png"></span></a>
...
<span class="icon-bar"></span>
<span class="icon-bar"></span>
<a class="navbar-btn sidebar-toggle" href="<?=SITE_PATH?>users/welcome"><i class="fa fa-home"  aria-hidden="true" style="font-size:20px; color:#fff"></i></span></a>
</a>
...
<div class="pull-left">
<? echo  $this->Html->link(__('Change Password', true),array('controller' => 'users','action'=>'changePassword'),array('class'=>'btn btn-default btn-flat'))?>
</div>
</li>
</ul>
</li>
...
<div class="wrapper row-offcanvas row-offcanvas-left nav-collapse">
<aside class="left-side sidebar-offcanvas">

<section class="sidebar">
<?php //print_r($sessionval['mainmenu']);?>
<? if($sessionval['type']==='regular' and !empty($sessionval['mainmenu'])){ 
if (in_array($this->request->params['controller'].":".$this->request->params['action'], $sessionval['mainmenu'])) { } else { 
	$this->requestAction(array('controller' => 'users', 'action' => 'checkRestriction',$sessionval['mainmenu'][1]));
}
