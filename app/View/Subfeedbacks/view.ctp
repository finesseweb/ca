...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Question'), array('action' => 'edit', $subcategory['Subfeedback']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Question'), array('action' => 'delete', $subcategory['Subfeedback']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $subcategory['Subfeedback']['id'])); ?>
<?php echo $this->Html->link(__('List Question'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<dd>
<?php echo h($subcategory['Subfeedback']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Question Name'); ?></dt>
<dd class="question">
<?php echo h($subcategory['Subfeedback']['name']); ?>
&nbsp;
</dd>


<dt><?php echo __('Responce One'); ?></dt>
<dd class="question">
<?php echo h($subcategory['Subfeedback']['responce_one']); ?>
&nbsp;
</dd>
<dt><?php echo __('Responce Two'); ?></dt>
<dd class="question">
<?php echo h($subcategory['Subfeedback']['responce_two']); ?>
&nbsp;
</dd>
<dt><?php echo __('Responce Three'); ?></dt>
<dd class="question">
<?php echo h($subcategory['Subfeedback']['responce_three']); ?>
&nbsp;
</dd>
<dt><?php echo __('Feedback'); ?></dt>
<dd>
<?php echo h(ucfirst($subcategory['Feedback']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($subcategory['Subfeedback']['status'])); ?>
&nbsp;
</dd>
