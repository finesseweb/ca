...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit District'), array('action' => 'edit', $city['City']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete District'), array('action' => 'delete', $city['City']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $city['City']['id'])); ?>
...
<dd>
<?php echo h(ucfirst($city['City']['name'])); ?>
&nbsp;
</dd>
