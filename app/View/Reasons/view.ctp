...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Reason'), array('action' => 'edit', $reason['Reason']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Reason'), array('action' => 'delete', $reason['Reason']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $reason['Reason']['id'])); ?>
<?php echo $this->Html->link(__('List Reason'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Html->link(__('New Reasonory'), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
...
<dd>
<?php echo h($reason['Financial']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Reason Name'); ?></dt>
<dd>
<?php echo h(ucfirst($reason['Reason']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Category Name'); ?></dt>
<dd>
<?php echo h(ucfirst($reason['Financial']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($reason['Reason']['status'])); ?>
&nbsp;
</dd>
