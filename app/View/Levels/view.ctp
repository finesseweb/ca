...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Feedback'), array('action' => 'edit', $feedback['Feedback']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Feedback'), array('action' => 'delete', $feedback['Feedback']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $feedback['Feedback']['id'])); ?>
<?php echo $this->Html->link(__('List Feedback'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Html->link(__('New Feedback'), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
