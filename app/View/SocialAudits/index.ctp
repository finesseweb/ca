...
<th><?php echo $this->Paginator->sort('issue_shared_jansamwad'); ?></th>
...
<td class="actions">
<a href="javascript:void(0)" class="more btn btn-success" data-toggle="modal" data-target="#myModal" data-id="<?=$anm['SocialAudit']['block']?>,<?=$anm['SocialAudit']['meeting_date']?>"">More</a>
<?php /*?><?php 
...
$.ajax({url:"<?=SITE_PATH?>/socialAudits/viewissue/"+dataid,dataType:"html",success:function(result){
