...
echo "<div class='col-sm-3'>".$this->Form->input('visit_date',array('type'=>'text','class'=>'calbsp form-control','label'=>'Date','value'=>date('d-m-Y',strtotime($this->request->data['AfcHomeVisit']['visit_date'])),'readonly'=>'readonly'))."</div>";
...
echo "<div class='col-sm-3'>".$this->Form->input('no_of_child',array('class' => 'form-control','type'=>'number','label'=>'No of child'))."</div>";
echo "<div class='col-sm-3'>".$this->Form->input('yonger_child_age',array('type'=>'text','type'=>'number','class' => 'form-control','label'=>'Age of younger child'))."</div>";
...
//echo "<div class='col-sm-3' id='beneficiary_couselled'>".$this->Form->input('beneficiary_couselled',array('class' => 'form-control','label'=>'Counselled by AFC to beneficiary','options'=>array(''=>'Select Option',$opt)))."</div>";
?>
<div class="col-sm-3" id="beneficiary_couselled">
<div class="input select">
<label for="AfcHomeVisitBeneficiaryCouselled">Counselled by AFC to beneficiary</label>
<select name="data[AfcHomeVisit][beneficiary_couselled][]" multiple="multiple" class="form-control" id="AfcHomeVisitBeneficiaryCouselled" style="display: none;">
<?php foreach($opt as $key=>$value) {
 $men =explode(',',$this->request->data['AfcHomeVisit']['beneficiary_couselled']);
?>
...
if($this->request->data['AfcHomeVisit']['contraceptives_delivery_date']!='1970-01-01' && $this->request->data['AfcHomeVisit']['contraceptives_delivery_date']!='0000-00-00' && $this->request->data['AfcHomeVisit']['contraceptives_delivery_date']!='') {
echo "<div class='col-sm-3' id='contraceptivesdeliverydate'>".$this->Form->input('contraceptives_delivery_date',array('class' => 'form-control','type'=>'text','label'=>'If Spacing - Possible Date for delivery of contraceptives','value'=>date('d-m-Y',strtotime($this->request->data['AfcHomeVisit']['contraceptives_delivery_date']))))."</div>";
} else {
...
if($this->request->data['AfcHomeVisit']['follow_visit_date']!='1970-01-01' && $this->request->data['AfcHomeVisit']['follow_visit_date']!='0000-00-00' && $this->request->data['AfcHomeVisit']['follow_visit_date']!='') {
echo "<div class='col-sm-3' id='visitDate'>".$this->Form->input('follow_visit_date',array('class' => 'form-control','type'=>'text','value'=>date('d-m-Y',strtotime($this->request->data['AfcHomeVisit']['follow_visit_date']))))."</div>";

}
else {
//echo "<div class='col-sm-3' id='visitDate'>".$this->Form->input('follow_visit_date',array('class' => 'form-control','type'=>'text'))."</div>";
...
?>
<?php 
echo "<a href='#' class='btn btn-danger intro'>Process Data please Wait ---</a>";
