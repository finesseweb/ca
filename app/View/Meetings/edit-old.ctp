...
echo "<div class='col-sm-3'>".$this->Form->input('project_id',array('class' => 'form-control'),array('options'=>array(''=>'Select',$projects)))."</div><div class='col-sm-3'>".$this->Form->input('user_id',array('class' => 'form-control'),array('options'=>array(''=>'Select',$users)))."</div>";
...
echo "<div class='col-sm-3'>".$this->Form->input('meeting_place',array('class' => 'form-control'))."</div><div class='col-sm-3'>".$this->Form->input('first_response',array('class' => 'form-control'),array('options'=>$res,'selected'=>array($this->data['Meeting']['first_response'])))."</div>";
echo "<div class='col-sm-3'>".$this->Form->input('representative',array('class' => 'form-control'),array('options'=>array(''=>'Select',$users)))."</div><div class='col-sm-3'>".$this->Form->input('second_representative',array('class'=>'notrequired form-control','options'=>array(''=>'Select',$users)))."</div>";
echo "<div class='col-sm-3'>".$this->Form->input('status',array('class' => 'form-control'),array('options'=>array('pending'=>'Pending','close'=>'Close','done'=>'Done','postponed'=>'Postponed','cancel'=>'Cancel')))."</div><div class='col-sm-3'>".$this->Form->input('response',array('class' => 'form-control'),array('options'=>$res,'selected'=>array($this->data['Meeting']['response'])))."</div>";
echo "<div class='col-sm-3'>".$this->Form->input('form_received',array('class' => 'form-control'),array('options'=>array(''=>'Select','yes'=>'Yes','no'=>'No')))."</div><div class='col-sm-3'>".$this->Form->input('form_repeat',array('class' => 'form-control'),array('options'=>array('new'=>'New','repeat one'=>'Repeat one','repeat two'=>'Repeat two','repeat three'=>'Repeat three','repeat four'=>'Repeat four','repeat five'=>'Repeat five','repeat six'=>'Repeat Six','many times'=>'Many Times')))."</div>";
