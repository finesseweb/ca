...
<div class="col-sm-2"><input type="button" name="reset" value="export_remark" class="btn btn-block" onclick="window.open('<?=SITE_PATH?>enquiries/export_remark/?<?=$_SERVER['QUERY_STRING']?>','abhay','scrollbars=1,width=1400,height=650,left=100,top=50')"/>
<input type="button" name="reminder" value="send reminder" class="btn btn-block" id="reminder"/>
</div> 
<? } ?>
</div></div>
</div>
...
$.ajax({
url:"<?=SITE_PATH?>enquiries/dailyExecutiveReminderMailReport/",
