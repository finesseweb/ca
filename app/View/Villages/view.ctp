...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Village'), array('action' => 'edit', $village['Village']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Village'), array('action' => 'delete', $village['Village']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $village['Village']['id'])); ?>
...
<dd>
<?php echo h(ucfirst($village['City']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Block'); ?></dt>
<dd>
<?php echo h(ucfirst($village['Block']['name'])); ?>
&nbsp;
</dd>

<dt><?php echo __('Panchyat'); ?></dt>
<dd>
<?php echo $this->Html->link(ucfirst($village['Panchayat']['name']), array('controller' => 'panchayats', 'action' => 'view', $village['Panchayat']['id'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Village Name'); ?></dt>
<dd>
<?php echo h(ucfirst($village['Village']['name'])); ?>
&nbsp;
</dd>
</dl>
</div>
