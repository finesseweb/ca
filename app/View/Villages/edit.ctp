...
<div class="btn-group">
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Village.id')),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $this->Form->value('City.id'))); ?>
<?php echo $this->Html->link(__('List Village'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<fieldset>
<legend><?php echo __('Edit Village'); ?></legend>
<?php
