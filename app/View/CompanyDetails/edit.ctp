...
//print_r($this->request->data['CompanyDetail']);
...
echo $this->Form->input('company_logo1',array('type'=>'hidden','class' => 'form-control','value'=>$this->request->data['CompanyDetail']['company_logo']));
echo $this->Form->input('signature1',array('type'=>'hidden','class' => 'form-control','value'=>$this->request->data['CompanyDetail']['signature']));
...
$( "#CompanyDetailMobileOne" ).blur(function() {
    var c=$(this).val();
    if (c.length<10)
           {
                alert("Enter min 10 digit");
              // $("#CompanyDetailMobileOne").focus();
               setTimeout(function(){$('#CompanyDetailMobileOne').focus();}, 2);
           }
         else if(c.length>10){
    ...
    $( "#CompanyDetailMobileTwo" ).blur(function() {
    var c=$(this).val();
    if (c.length<10)
           {
                alert("Enter min 10 digit");
              // $("#CompanyDetailMobileOne").focus();
               setTimeout(function(){$('#CompanyDetailMobileTwo').focus();}, 2);
           }
         else if(c.length>10){
            alert("Enter max 10 digit");
                setTimeout(function(){$('#CompanyDetailMobileTwo').focus();}, 2);
