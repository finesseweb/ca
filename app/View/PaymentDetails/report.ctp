...
<div class="col-sm-4"><img src="<?=SITE_PATH?>images/<?=$invoicedetails['0']['CompanyDetail']['company_logo']?>"></div>
...
<hr class="new3">
    ...
    <h4>Mr. <?=$invoicedetails['0']['ClientDetail']['name_of_client']?></h5> 
    <h4>Mr. <?=$invoicedetails['0']['ClientDetail']['district_c']?>,<?=$invoicedetails['0']['ClientDetail']['state_c']?></h5> 
    <h4 class="center">Income Tax PAN : <?=$invoicedetails['0']['ClientDetail']['pan_number']?></h4>
    
    </div>
    <div class="col-sm-12"><div class="col-sm-6"><h5 style="margin-left: -25px;">Bill Number : <?=$invoicedetails['0']['Finance']['bill_number']?></h5></div>
        <div class="col-sm-6">  <h5 style="float:right">Date : <?=date('m-d-Y',strtotime($invoicedetails['0']['Finance']['billing_date']))?></h5></div></div>
  <div class="col-sm-12"> 
 <div class="row table-bordered">
<table class="table table-hover table-condensed  table-bordered inventory" style="border: 1px solid; margin-bottom:0px!important"> 
        <thead>
        <th style="width:80%;">Description</th><th style="width:20%;">Amount (Rs.)</th></thead>
        <tbody>
             <?php 
          ...
          <tr>
              <td><?=$invoice['Finance']['description_details']?></td><td style="text-align:right;"><?=$invoice['Finance']['amount']?>:00 </td>
    ...
    <table class="balance">
				<tr>
					...
					<td><span><?=$invoice['Finance']['current_total_amount']?>.00</span></td>
				</tr>
				<tr>
					<th><span contenteditable>Less- Advance</span></th>
					<td><span contenteditable><?=$invoice['Finance']['advance_amount']?>.00</span></td>
				</tr>
				<tr>
					<th><span contenteditable>Balance Payable</span></th>
					<td><span><?=$invoice['Finance']['current_total_amount']-$invoice['Finance']['advance_amount']?>.00</span></td>
				</tr>
			</table>
          
</div>
</div>
<div class="col-sm-12" style="margin-top: 10px; margin-bottom: 12px">
