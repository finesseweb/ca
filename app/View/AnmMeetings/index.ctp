...
<th><?php echo $this->Paginator->sort('decisions_taken'); ?></th>
...
<td class="actions">
<a href="javascript:void(0)" class="more btn btn-success" data-toggle="modal" data-target="#myModal" data-id="<?=$anm['AnmMeeting']['block']?>,<?=$anm['AnmMeeting']['meeting_date']?>">More</a>
<?php /*?><?php 
...
$.ajax({url:"<?=SITE_PATH?>/anmmeetings/viewissues/"+dataid,dataType:"html",success:function(result){
