...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Register Member'), array('action' => 'edit', $discussion['Discussion']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Register Member'), array('action' => 'delete', $discussion['Discussion']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $discussion['Discussion']['id'])); ?>
...
<dd>
<?php echo h(ucfirst($discussion['Discussion']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($discussion['Discussion']['status'])); ?>
&nbsp;
</dd>
