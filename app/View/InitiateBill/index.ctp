...
<th><?php echo $this->Paginator->sort('compnay'); ?></th>
<th><?php //echo $this->Paginator->sort('grant_period'); ?>Financial Period</th>
...
<tr>
<td><?php echo h($financial['InitiateBill']['id']); ?></td>
...
<td><?php echo h(ucfirst($financial['InitiateBill']['bill_number'])); ?></td>
<?php /*?><td>
    <!--<a href="javascript:void(0)" class="moredetails" data-toggle="modal" data-target="#myModal" data-id="<?=$financial['InitiateBill']['cat_id']?>">-->
    <?php 
$subtotal = $this->requestAction(array("controller"=>"financialDetails","action"=>"getall",$financial['InitiateBill']['cat_id'])); 
echo $subtotal; 
?><!--</a>--></td><?php */?>
<td><?php echo h(ucfirst($financial['InitiateBill']['status'])); ?></td>
<td class="actions">
<!--<a href="javascript:void(0)" class="moredetails btn btn-success" data-toggle="modal" data-target="#myModal" data-id="<?=$financial['InitiateBill']['cat_id']?>">More</a>-->
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financial['InitiateBill']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financial['InitiateBill']['id']),array('class' => 'btn btn-danger'), null, __('Are you sure you want to delete # %s?', $financial['InitiateBill']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</table>
