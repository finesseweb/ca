...
<div class="actions">
<h2><?php echo __('Financial Details'); ?></h2>
</div>
<div class="btn-group">
<?php echo $this->Html->link(__('Initiate New Bill'), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
...
<th><?php //echo $this->Paginator->sort('Subcategory'); ?>Subcategory</th>
<th><?php //echo $this->Paginator->sort('grant_period'); ?>Grant Period</th>
<th><?php echo $this->Paginator->sort('unit_cost'); ?></th>
<th><?php //echo $this->Paginator->sort('No of Unit'); ?>No of Unit</th>
...
<tr>
<td><?php echo h($financial['FinancialDetail']['id']); ?></td>
<td><?php echo h(ucfirst($financial['Ngo']['name_of_ngo'])); ?></td>
<td><?php echo h(ucfirst($financial['Financial']['name'])); ?></td>
<td><?php echo h(ucfirst($financial['Subcategory']['name'])); ?></td>
<td><?php echo h(date('d-m-Y',strtotime($financial['Period']['from_date'])).' To '.date('d-m-Y',strtotime($financial['Period']['to_date']))); ?></td>
<td><?php echo h(ucfirst($financial['FinancialDetail']['unit_cost'])); ?>:00</td>
<td><?php echo h(ucfirst($financial['FinancialDetail']['no_of_unit'])); ?></td>
<td><?php echo h(ucfirst($financial['FinancialDetail']['frequency'])); ?></td>
<td><?php echo h(ucfirst($financial['FinancialDetail']['amount'])); ?>:00</td>
<?php /*?><td>
...
echo $subtotal; 
?><!--</a>--></td><?php */?>
<td><?php echo h(ucfirst($financial['FinancialDetail']['status'])); ?></td>
<td class="actions">
...
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financial['FinancialDetail']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financial['FinancialDetail']['id']),array('class' => 'btn btn-danger'), null, __('Are you sure you want to delete # %s?', $financial['FinancialDetail']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</table>
