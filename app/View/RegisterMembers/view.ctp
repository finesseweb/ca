...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Register Member'), array('action' => 'edit', $registers['RegisterMember']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Register Member'), array('action' => 'delete', $registers['RegisterMember']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $registers['RegisterMember']['id'])); ?>
...
<dd>
<?php echo h($registers['RegisterMember']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('Name'); ?></dt>
<dd>
<?php echo h(ucfirst($registers['RegisterMember']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($registers['RegisterMember']['status'])); ?>
&nbsp;
</dd>
