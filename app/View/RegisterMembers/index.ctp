...
<h2><?php echo __('Registers Members'); ?></h2>
...
<tr>
<td><?php echo h($register['RegisterMember']['id']); ?>&nbsp;</td>
<td><?php echo h(ucfirst($register['RegisterMember']['name'])); ?>&nbsp;</td>

<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $register['RegisterMember']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $register['RegisterMember']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $register['RegisterMember']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $register['RegisterMember']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
