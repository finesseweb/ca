...
<div class="btn-group">
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RegisterMember.id')),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $this->Form->value('RegisterMember.id'))); ?>
...
<?php echo $this->Form->create('RegisterMember'); ?>
<fieldset>
<legend><?php echo __('Edit Register Member'); ?></legend>
<?php
