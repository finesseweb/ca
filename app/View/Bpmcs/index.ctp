...
<td class="actions">
<a href="javascript:void(0)" class="more btn btn-success" data-toggle="modal" data-target="#myModal" data-id="<?=$anm['Bpmc']['block']?>,<?=$anm['Bpmc']['meeting_date']?>">More</a>
<?php /*?><?php 
...
$.ajax({url:"<?=SITE_PATH?>/bpmcs/viewissues/"+dataid,dataType:"html",success:function(result){
