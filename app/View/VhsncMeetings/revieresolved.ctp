...
<style>
    ...
    <div class="actions"><h2><?php echo __('VHSNC Issue Resolved'); ?></h2></div>
...
<?php echo $this->Html->link(__('Resolved Issues'), array('controller' => 'vhsncMeetings','action' => 'revieresolved'),array('class' => 'btn btn-primary showactive')); ?>
...
<div class="row">
<form id="mastersearch" mathod="get" action="<?=SITE_PATH?>vhsncMeetings/revieresolved">
...
<div class="col-sm-1"><input type="button" name="reset" value="Reset" class="btn btn-warning btn-block" onclick="window.location.href='<?=SITE_PATH?>vhsncMeetings/revieresolved'"/></div>
<div class="col-sm-1" style="float:right;"><input type="button" name="reset" value="Export" class="btn btn-block export" onclick="window.open('<?=SITE_PATH?>vhsncMeetings/exportresolvedissue/?<?=$_SERVER['QUERY_STRING']?>','abhay','scrollbars=1,width=1400,height=650,left=100,top=50')"/></div>
