...
<div class="btn-group">
<?php echo $this->Html->link(__('List Issue Details'), array('controller'=>'issues','action' => 'index'),array('class' => 'btn btn-primary')); ?>
</div>
</div>
...
echo "<div class='col-sm-3'>".$this->Form->input('panchayat',array('class' => 'form-control','options'=>array(''=>'--Select--',$panchayat),'disabled'=>'disabled'))."</div>";
echo "<div class='col-sm-3'>".$this->Form->input('village',array('class' => 'form-control','options'=>array(''=>'All Village',$village),'disabled'=>'disabled'))."</div>";
...
echo $this->Form->input('decision_taken',array('class' => 'form-control','type'=>'hidden','label'=>'Decisions Taken (No.)','readonly'=>'readonly','max'=>'9'));
echo $this->Form->input('solved_issue',array('class' => 'form-control','type'=>'hidden','label'=>'Issues resolved (No.)','readonly'=>'readonly','max'=>'9'));
...
echo "<div class='col-sm-12'>";
echo "<div class='row'>";
echo "<div class='col-sm-3'>".$this->Form->input('decisions_taken',array('class' => 'form-control','label'=>'Decision Taken <span style="color:red">*</span>','name'=>'data[VhsncMeeting][decisions_taken]','required'=>'required','options'=>array(''=>'Select','yes'=>'Yes','no'=>'No')))."</div>";
...
echo "<div class='col-sm-12'>";
echo "<div class='row'>";
echo "<div class='col-sm-3' id='issuedate'>".$this->Form->input('issue_resolved_date',array('class' => 'form-control','name'=>'data[VhsncMeeting][issue_resolved_date]','type'=>'text','label'=>'Date of Resolved Issued','value'=>date('d-m-Y',strtotime($this->request->data['VhsncMeeting']['issue_resolved_date']))))."</div>";
...
echo "<div class='col-sm-4'>".$this->Form->input('letter_issued_bpmc',array('class' => 'form-control','name'=>'data[VhsncMeeting][letter_issued_bpmc]','type'=>'text','label'=>'Letter Issued to Higher Authority/ BPMC'))."</div>";
...
var d= $("#VhsncMeetingIssueResolved").val();
if(d==='no' || d===''){
  $("#VhsncMeetingIssueResolvedDate").val(''); 
}
else {
