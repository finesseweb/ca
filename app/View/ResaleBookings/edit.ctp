...
<div class="btn-group"><?php echo $this->Html->link(__('List Resale Bookings'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?></div>
</div>
...
<fieldset>
<legend><?php echo __('Edit Resale Booking'); ?></legend>
<?php
echo "<div class='col-sm-3'>".$this->Form->input('id').$this->Form->input('date_of_booking',array('class' => 'form-control','type'=>'text','onFocus'=>'showDate("ResaleBookingDateOfBooking")'))."</div><div class='col-sm-3'>".$this->Form->input('builder_id',array('class' => 'form-control'))."</div><div class='col-sm-3'>".$this->Form->input('project_id',array('class' => 'form-control'))."</div>";
