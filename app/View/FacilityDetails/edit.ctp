...
//echo "<div class='col-sm-3'>".$this->Form->input('anm_name',array('type'=>'text','class' => 'form-control','label'=>'ANM Name'))."</div>";
//echo " <div class='col-sm-3'>".$this->Form->input('anm_mobile',array('class' => 'form-control','label'=>'ANM Mobile','type'=>'number'))."</div>";
