...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Block'), array('action' => 'edit', $block['Block']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Block'), array('action' => 'delete', $block['Block']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $block['Block']['id'])); ?>
<?php echo $this->Html->link(__('List Block'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<dd>
<?php echo h(ucfirst($block['Block']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('District'); ?></dt>
<dd>
<?php echo $this->Html->link(ucfirst($block['City']['name']), array('controller' => 'cities', 'action' => 'view', $block['City']['id'])); ?>
&nbsp;
</dd>
</dl>
</div>
