...
<div class="btn-group">
<?php echo $this->Html->link(__('New Subategory'), array('action' => 'add'),array('class' => 'btn btn-primary')); ?>
...
<h2><?php echo __('Financials Subcategory'); ?></h2>
...
<td><?php echo h(ucfirst($subcategory['Subcategory']['name'])); ?>&nbsp;</td>
<td><?php echo h(ucfirst($subcategory['Financial']['name'])); ?>&nbsp;</td>
<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $subcategory['Subcategory']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $subcategory['Subcategory']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $subcategory['Subcategory']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $subcategory['Subcategory']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
