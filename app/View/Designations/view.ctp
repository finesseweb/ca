...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Designations'), array('action' => 'edit', $designation['Designation']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Designations'), array('action' => 'delete', $designation['Designation']['id']),array('class' => 'btn btn-primary'), null, __('Are you sure you want to delete # %s?', $designation['Designation']['id'])); ?>
...
<dd>
<?php echo h(ucfirst($designation['Designation']['name'])); ?>
&nbsp;
</dd>
</dl>
</div>
