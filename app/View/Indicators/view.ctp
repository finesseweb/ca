...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Cateory'), array('action' => 'edit', $financial['Financial']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Cateory'), array('action' => 'delete', $financial['Financial']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $financial['Financial']['id'])); ?>
...
<dd>
<?php echo h(ucfirst($financial['Indicator']['name'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($financial['Indicator']['status'])); ?>
&nbsp;
</dd>
