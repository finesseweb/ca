...
<tr>
<td><?php echo h($financial['Indicator']['id']); ?>&nbsp;</td>
<td><?php echo h(ucfirst($financial['Indicator']['name'])); ?>&nbsp;</td>

<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $financial['Indicator']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financial['Indicator']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financial['Indicator']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $financial['Indicator']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
