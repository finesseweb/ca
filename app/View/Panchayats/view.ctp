...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Panchayat'), array('action' => 'edit', $panchayat['Panchayat']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Panchayat'), array('action' => 'delete', $panchayat['Panchayat']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $panchayat['Panchayat']['id'])); ?>
<?php echo $this->Html->link(__('List Panchayats'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<h2><?php echo __('Panchayat'); ?></h2>
<dl>
<dt><?php echo __('District'); ?></dt>
<dd>
<?php echo h(ucfirst($panchayat['City']['name'])); ?>
&nbsp;
</dd>

<dt><?php echo __('Block'); ?></dt>
<dd>
<?php echo $this->Html->link(ucfirst($panchayat['Block']['name']), array('controller' => 'blocks', 'action' => 'view', $panchayat['Block']['id'])); ?>
&nbsp;
</dd>
<dt><?php echo __('Panchayat Name'); ?></dt>
<dd>
<?php echo h(ucfirst($panchayat['Panchayat']['name'])); ?>
&nbsp;
</dd>
</dl>
</div>
