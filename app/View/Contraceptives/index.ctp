...
<h2><?php echo __('Contraceptives'); ?></h2>
...
<tr>
<td><?php echo h($contraceptive['Contraceptive']['id']); ?>&nbsp;</td>
<td><?php echo h(ucfirst($contraceptive['Contraceptive']['name'])); ?>&nbsp;</td>

<td class="actions">
<?php echo $this->Html->link(__('View'), array('action' => 'view', $contraceptive['Contraceptive']['id']),array('class' => 'btn btn-success')); ?>
<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $contraceptive['Contraceptive']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $contraceptive['Contraceptive']['id']),array('class' => 'btn btn-danger'), array(), __('Are you sure you want to delete # %s?', $contraceptive['Contraceptive']['id'])); ?>
</td>
</tr>
<?php endforeach; ?>
</tbody>
