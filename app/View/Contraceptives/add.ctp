...
<div class="btn-group">
<?php echo $this->Html->link(__('List Contraceptives'), array('action' => 'index'),array('class' => 'btn btn-primary')); ?>
...
<?php echo $this->Form->create('Contraceptive'); ?>
<fieldset>
<legend><?php echo __('Add Contraceptive'); ?></legend>
<?php
