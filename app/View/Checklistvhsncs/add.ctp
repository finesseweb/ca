        ...
        <tbody>
          ...
          <tr>
              <td colspan="3"style="background-color: #C0BFBA;"><?=ucwords($feedback['Feedback']['name'])?>
                  <input type="hidden" class="feed" name="data[Checklistvhsnc][hidden][]" id="ChecklistvhsncHidden" value="<?=$feedback['Feedback']['id']?>">
              </td>
          ...
          <tr class="<?=$value['Subfeedback']['level']?>"><td style="background-color: aliceblue" class="question" id="feedId<?=ucfirst($value['Subfeedback']['id'])?>">
              ...
              <input type="hidden" name="data[Checklistvhsnc][question_id][]" readonly="readonly" value="<?=ucfirst($value['Subfeedback']['id'])?>">
              
              </td>
              <td style="width: 14%"> <select class="form-control question" name="data[Checklistvhsnc][response][]" id="responce<?=ucfirst($value['Subfeedback']['id'])?>">
          ...
          <td><input class="form-control question" type="text" name="data[Checklistvhsnc][feedback_remarks][]"></td>
          </tr>
