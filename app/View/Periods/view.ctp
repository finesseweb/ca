...
<div class="btn-group">
<?php echo $this->Html->link(__('Edit Financial Year'), array('action' => 'edit', $periods['Period']['id']),array('class' => 'btn btn-primary')); ?>
<?php echo $this->Form->postLink(__('Delete Financial Year'), array('action' => 'delete', $periods['Period']['id']),array('class' => 'btn btn-primary'), array(), __('Are you sure you want to delete # %s?', $periods['Period']['id'])); ?>
...
<dd>
<?php echo h($periods['Period']['id']); ?>
&nbsp;
</dd>-->
<dt><?php echo __('From Date'); ?></dt>
<dd>
<?php echo h(date('d-m-Y',strtotime($periods['Period']['from_date']))); ?>
&nbsp;
</dd>
<dt><?php echo __('To Date'); ?></dt>
<dd>
<?php echo h(date('d-m-Y',strtotime($periods['Period']['to_date']))); ?>
&nbsp;
</dd>
<dt><?php echo __('Status'); ?></dt>
<dd>
<?php echo h(ucfirst($periods['Period']['status'])); ?>
&nbsp;
</dd>
