...
<div class="row">
    ...
    <div class="col-sm-3"><div class="input select"><label for="DpoFirstName">Name <span class="after">*</span></label><select name="data[Dpo][first_name]" class="form-control" id="DpoFirstName" required="required">
...
//print_r($executives);
//echo "<div class='col-sm-3'>".$this->Form->input('first_name',array('class'=>'form-control','options'=>array(''=>'Select User',$executives['0']['User']['name'].' '.$executives['0']['User']['last_name'])))."</div>";

//echo "<div class='col-sm-3'>".$this->Form->input('last_name',array('class' => 'form-control'))."</div>";
echo "<div class='col-sm-3'>".$this->Form->input('designation',array('class' => 'form-control','value'=>'DPO','readonly'=>'readonly'))."</div>";
