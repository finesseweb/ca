 ...
 */
	public function index() {
		$this->Paginator->settings = array('Indicator' => array('limit' =>10,'order' => array('name' => 'asc')));
 ...
 */
	public function view($id = null) {
		...
		$this->set('financial', $this->Indicator->find('first', $options));
	}
	...
	public function edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->Indicator->save($this->request->data)) {
				...
				$this->Session->setFlash(__('The Indicator category could not be saved. Please, try again.'));
			}
		} else {
			$options = array('conditions' => array('Indicator.' . $this->Indicator->primaryKey => $id));
 ...
 */
	public function delete($id = null) {
		...
		$subcatlist=$this->Indicator->find('list',array("conditions"=>array('city_id'=>$stateid)));
